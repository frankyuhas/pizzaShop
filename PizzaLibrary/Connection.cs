...
namespace Utilities
{
    public class DBConnect
    {
        ...
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp20_3342_tuxxxxx;User id=tuxxxxxx;Password=xxxxxxxx";

        // Home Connection String - used for working from home using SSH Tunneling.
        String SqlConnectString = "server=127.0.0.1,5555;Database=sp21_3342_tuxxxxx;User id=tuxxxxxx;Password=xxxxxxxxx";
